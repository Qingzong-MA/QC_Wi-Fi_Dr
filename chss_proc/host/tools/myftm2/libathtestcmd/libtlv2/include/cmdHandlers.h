/*
 * Copyright (c) 2016, 2018-2019, 2023-2024 Qualcomm Technologies, Inc.
 *
 * All Rights Reserved.
...
typedef struct cmdAllParms {
    union {
        ...
        CMD_GETCTLTPCFTMDATASTANDALONE_PARMS		 cmdGETCTLTPCFTMDATASTANDALONEParms;
        CMD_GETCTLTPCFTMDATASTANDALONERSP_PARMS		 rspGETCTLTPCFTMDATASTANDALONERSPParms;
        CMD_SETCTLTPCTESTSCREEN_PARMS		 cmdSETCTLTPCTESTSCREENParms;
        CMD_SETCTLTPCTESTSCREENRSP_PARMS		 rspSETCTLTPCTESTSCREENRSPParms;
        CMD_GETCTLTPCFTMDATA_PARMS		 cmdGETCTLTPCFTMDATAParms;
        CMD_GETCTLTPCFTMDATARSP_PARMS		 rspGETCTLTPCFTMDATARSPParms;
        CMD_GETCTLSUPPORTEDINFO_PARMS		 cmdGETCTLSUPPORTEDINFOParms;
        CMD_GETCTLSUPPORTEDINFORSP_PARMS		 rspGETCTLSUPPORTEDINFORSPParms;
        CMD_SETCTLEXCEPTIONVALUE_PARMS		 cmdSETCTLEXCEPTIONVALUEParms;
        ...
        CMD_WSICONFIG_PARMS		         cmdWSICONFIGParms;
        CMD_WSITRIGGERDOORBELL_PARMS		 cmdWSITRIGGERDOORBELLParms;
        CMD_CUST_RXGAINCALPROC_PARMS		cmdCUST_RXGAINCALPROCParms;
        CMD_CUST_RXGAINCALPROCRSP_PARMS		rspCUST_RXGAINCALPROCRSPParms;
