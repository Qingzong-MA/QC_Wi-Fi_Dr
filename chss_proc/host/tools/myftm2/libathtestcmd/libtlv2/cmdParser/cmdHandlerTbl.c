...
CMD_HANDLER_ENTRY CmdHandlerTbl[] = {
    ...
    /* following NULL is needed as the place holder for each command
     * response handler to maintain correct indexing.
     */
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    ...
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {initOFDMATONEPLANOpParms, OFDMATONEPLANOp, NULL},
    {initOFDMATONEPLANRSPOpParms, OFDMATONEPLANRSPOp, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    ...
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {initDPDLOOPBACKINFOOpParms, DPDLOOPBACKINFOOp, NULL},
    {initDPDLOOPBACKINFORSPOpParms, DPDLOOPBACKINFORSPOp, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {initSETPERCHAINPWROpParms, SETPERCHAINPWROp, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    ...
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {initOFDMAULTXCONFIGOpParms, OFDMAULTXCONFIGOp, NULL},
    {initOFDMAULTXCONFIGRSPOpParms, OFDMAULTXCONFIGRSPOp, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {initSETLOWPOWEROpParms, SETLOWPOWEROp, NULL},
    {initEEPROMWRITEOpParms, EEPROMWRITEOp, NULL},
    {initEEPROMREADOpParms, EEPROMREADOp, NULL},
    {initEEPROMREADRSPOpParms, EEPROMREADRSPOp, NULL},
    {initEEPROMGETSIZEOpParms, EEPROMGETSIZEOp, NULL},
    {initEEPROMGETSIZERSPOpParms, EEPROMGETSIZERSPOp, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {initRSTOpParms, RSTOp, NULL},
    {initRSTRSPOpParms, RSTRSPOp, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    ...
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {initCUST_RXGAINCALPROCOpParms, CUST_RXGAINCALPROCOp, NULL},
    {initCUST_RXGAINCALPROCRSPOpParms, CUST_RXGAINCALPROCRSPOp, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {initSETCTLEXCEPTIONVALUEOpParms, SETCTLEXCEPTIONVALUEOp, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {initGETCTLSUPPORTEDINFOOpParms, GETCTLSUPPORTEDINFOOp, NULL},
    {initGETCTLSUPPORTEDINFORSPOpParms, GETCTLSUPPORTEDINFORSPOp, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {initSETCTLTPCTESTSCREENOpParms, SETCTLTPCTESTSCREENOp, NULL},
    {initSETCTLTPCTESTSCREENRSPOpParms, SETCTLTPCTESTSCREENRSPOp, NULL},
    {initGETCTLTPCFTMDATAOpParms, GETCTLTPCFTMDATAOp, NULL},
    {initGETCTLTPCFTMDATARSPOpParms, GETCTLTPCFTMDATARSPOp, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {initGETCTLTPCFTMDATASTANDALONEOpParms, GETCTLTPCFTMDATASTANDALONEOp, NULL},
    {initGETCTLTPCFTMDATASTANDALONERSPOpParms, GETCTLTPCFTMDATASTANDALONERSPOp, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    ...
    {NULL, NULL, NULL},
    {NULL, NULL, NULL},
    {initWSICONFIGOpParms, WSICONFIGOp, NULL},
    {initWSITRIGGERDOORBELLOpParms, WSITRIGGERDOORBELLOp, NULL},
