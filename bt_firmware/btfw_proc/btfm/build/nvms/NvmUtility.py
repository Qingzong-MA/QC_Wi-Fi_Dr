...
NVM_TLV_VERSION_BT = 2
NVM_TLV_VERSION_FM = 3
NVM_TLV_VERSION_BTFM = 4
NVM_TLV_VERSION = 2

NVM_TLV_DATA_START = 4
NVM_TLV_TAG = 2
NVM_TLV_LEN = 2
# TAG POINTER ( 4 bytes ) and EXTENDED FLAGS ( 4 Bytes )
        ...
        with open(fname, 'r') as fobj:
            for line in fobj:
                if 'TagNum' in line:
                    ...
                    continue
            fobj.close()
    #Reading BUILD LABEL as TAG Number 1 and adding the details to NVM Objects     
    if BUILD_LABEL:
