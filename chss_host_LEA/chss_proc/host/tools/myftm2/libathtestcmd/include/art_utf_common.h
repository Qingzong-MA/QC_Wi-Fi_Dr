...
typedef enum {
    ...
    PHY_RF_MODE_DBS_PHY0_PHY1 = 1,
    PHY_RF_MODE_SBS_PHY0_PHY1 = 2,
    PHY_RF_MODE_NON_DBS_PHY1 = 3,
    PHY_RF_MODE_DBS_DBS = 4,
    PHY_RF_MODE_DBS_OR_SBS = 5,
    PHY_RF_MODE_DBS_PHY1_PHY0 = 6,
} PHY_RF_MODE;

typedef enum {
  TCMD_RATEBW_CW = -1,
  TCMD_RATEBW_CCK = 0,
  TCMD_RATEBW_LEGACY_OFDM =1,
  TCMD_RATEBW_HT20 = 2,
  TCMD_RATEBW_HT40 = 3,
  TCMD_RATEBW_VHT20 = 4,
  TCMD_RATEBW_VHT40 = 5,
  TCMD_RATEBW_VHT80 = 6,
  TCMD_RATEBW_VHT80P80 = 7,
  TCMD_RATEBW_HE20 = 8,
  TCMD_RATEBW_HE40 = 9,
  TCMD_RATEBW_HE80 = 10,
  TCMD_RATEBW_HE80P80 = 11,
  TCMD_RATEBW_OFDMA_HE20 = 12,
  TCMD_RATEBW_OFDMA_HE40 = 13,
  TCMD_RATEBW_OFDMA_HE80 = 14,
  TCMD_RATEBW_OFDMA_HE80P80 = 15,
  TCMD_RATEBW_HE160 = 16,
  TCMD_RATEBW_OFDMA_HE160 = 17,
  TCMD_RATEBW_HE165 = 18 ,
  TCMD_RATEBW_OFDMA_HE165 = 19,
  TCMD_RATEBW_VHT160 = 20,
  TCMD_RATEBW_VHT165 = 21,

  TCMD_RATEBW_11AX_HE320 = 22,
  TCMD_RATEBW_11AX_OFDMA_HE320 = 23,
  TCMD_RATEBW_11BE_EHT20 = 30,
  TCMD_RATEBW_11BE_EHT40 = 31,
  TCMD_RATEBW_11BE_EHT80 = 32,
  TCMD_RATEBW_11BE_EHT160 = 33,
  TCMD_RATEBW_11BE_EHT320 = 34,
  TCMD_RATEBW_11BE_OFDMA_EHT20 = 35,
  TCMD_RATEBW_11BE_OFDMA_EHT40 = 36,
  TCMD_RATEBW_11BE_OFDMA_EHT80 = 37,
  TCMD_RATEBW_11BE_OFDMA_EHT160 = 38,
  TCMD_RATEBW_11BE_OFDMA_EHT320 = 39,
  TCMD_RATEBW_INVALID
} TCMD_RATEBW;
...
typedef enum {
    WIFI_STANDARD_DEFAULT = 0,
    WIFI_STANDARD_LEGACY_AC,
    WIFI_STANDARD_LEGACY_AX,
    WIFI_STANDARD_OFDMA,
} TCMD_WIFI_STANDARD;
