...
ifeq ($(CONFIG_PADDR_CHECK_ON_3TH_PLATFORM), y)
cppflags-y += -DQCA_PADDR_CHECK_ON_3TH_PLATFORM
endif
...
cppflags-$(CONFIG_USE_CUSTOMIZED_DMA_MEM) += -DQCA_USE_CUSTOMIZED_DMA_MEM
ifeq ($(CONFIG_QCA6290_11AX), y)
cppflags-y += -DQCA_WIFI_QCA6290_11AX -DQCA_WIFI_QCA6290_11AX_MU_UL
endif

cppflags-$(CONFIG_WCNSS_DMA_PRE_ALLOC) += -DWCNSS_DMA_PRE_ALLOC
...
cppflags-$(CONFIG_CUSTOMIZED_WOW) += -DCUSTOMIZED_WOW
