...
{
	switch (ep) {
	case EP_TM_CMD_GET_VERSION:
		*driv_ep = ATH11K_TM_CMD_GET_VERSION;
	break;
	case EP_TM_CMD_TESTMODE_START:
		*driv_ep = ATH11K_TM_CMD_TESTMODE_START;
	break;
	case EP_TM_CMD_TESTMODE_STOP:
		*driv_ep = ATH11K_TM_CMD_TESTMODE_STOP;
	break;
	case EP_TM_CMD_WMI:
		*driv_ep = ATH11K_TM_CMD_WMI;
	break;
	case EP_TM_CMD_WMI_FTM_SEGMENTED:
		*driv_ep = ATH11K_TM_CMD_WMI_FTM;
	break;
	default:
...
#else
	NLA_PUT_U32(msg, ATH10K_TM_ATTR_CMD, cfg->ep);
#endif

	//NLA_PUT_U32(msg, ATH10K_TM_ATTR_WMI_CMDID, 0x1d002);
