...
ifneq ($(CNSS2_PLATFORM_NAME),)
	KBUILD_CPPFLAGS += -DCNSS2_PLATFORM_NAME=\"$(CNSS2_PLATFORM_NAME)\"
endif

ifneq ($(CONFIG_CNSS2_SLEEP_CLK),)
	KBUILD_CPPFLAGS += -DCNSS2_SLEEP_CLK=$(CONFIG_CNSS2_SLEEP_CLK)
endif
