...
#define LOG_TAG "BTAudioHalDeviceProxy_QTI_2_1"
...
BluetoothAudioPortOut::BluetoothAudioPortOut()
    : state_(BluetoothStreamState::DISABLED),
      ...
      cookie_(vendor::qti::bluetooth_audio::V2_1::kObserversCookieUndefined) {
  presentationPosition.bytes = 0;
  presentationPosition.remoteDelay_ns = 0;
  presentationPosition.timestamp.tv_sec = 0;
  presentationPosition.timestamp.tv_nsec = 0;
}
...
bool BluetoothAudioPortOut::SetUp(audio_devices_t devices) {
  ...
  return (cookie_ != vendor::qti::bluetooth_audio::V2_1::kObserversCookieUndefined);
}
...
bool BluetoothAudioPortOut::LoadAudioConfig_2_0(audio_config_t* audio_cfg) const {
  const AudioConfiguration_2_0& hal_audio_cfg =
    BluetoothAudioSessionControl::GetAudioConfig_2_0(session_type_);
...
bool BluetoothAudioPortOut::LoadAudioConfig(audio_config_t* audio_cfg) const {
  ...
  bool hal_2_1 = true;
  if (BluetoothAudioSessionControl::isClient_2_0(session_type_)) {
      hal_2_1 = false;
      return LoadAudioConfig_2_0(audio_cfg);
  }
...
bool BluetoothAudioPortOut::GetPresentationPosition(uint64_t* delay_ns,
  ...
  BluetoothAudioSessionControl::a2dpGetSinkLatency(session_type_, &remoteDelay,
          bytes, timestamp);
